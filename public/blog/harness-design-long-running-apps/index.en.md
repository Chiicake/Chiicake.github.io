...
---
Original article: [Harness design for long-running application development](https://www.anthropic.com/engineering/harness-design-long-running-apps) by Prithvi Rajasekaran.

*Written by Prithvi Rajasekaran, a member of Anthropic's [Labs](https://www.anthropic.com/news/introducing-anthropic-labs) team.*
...
![Initial screen when opening the app created by the solo harness](./assets/1_solo-open-screen.png)

![Creating a sprite in the sprite editor made by the solo harness](./assets/2_solo-sprite-editor.png)

![Trying unsuccessfully to play the level I created](./assets/3_solo-gameplay.png)
...
![Initial screen: Creating a new game, in the app built with the full harness](./assets/4_full-open-screen.png)

![The sprite editor felt cleaner and easier to use](./assets/5_full-sprite-editor.png)

![Using the built in AI feature to generate the level](./assets/6_ai-level-generate-1.png)

![Using the built in AI feature to generate the level](./assets/7_ai-level-generate-2.png)

![Playing the game I generated](./assets/8_full-gameplay.png)
